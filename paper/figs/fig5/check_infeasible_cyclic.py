...
from vndr.verify import lp_chebyshev
from vndr.modules import gale, vander
...
if __name__ == "__main__":
    ...
    parser.add_argument('--use-qr', action='store_true',
                        help='Whether to do spectral norm.')
    ...
    if args.parametrisation == 'gale':
        ...
        W = vander(args.N, args.D, args.use_qr)
    ...
    print(W)
    v = ArgmaxableSubsetVerifier(W=W, num_processes=int(os.environ['MLBL_NUM_PROC']), check_rank=False)
